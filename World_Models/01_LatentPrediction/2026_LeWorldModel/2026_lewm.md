...
**Training Objective**. Our objective is to learn latent representations useful for predicting the future, i.e., modeling the environment dynamics. LeWorldModel training objective is the sum of two terms: a prediction loss and a regularization loss. The prediction loss $\mathcal { L } _ { \mathrm { p r e d } }$ (teacher-forcing) computes the error between the predicted embedding of consecutive time-steps:

$$
\mathcal { L } _ { \mathrm { p r e d } } \triangleq \Vert \hat { z } _ { t + 1 } - z _ { t + 1 } \Vert _ { 2 } ^ { 2 } , \qquad \hat { z } _ { t + 1 } = \mathrm { p r e d } _ { \phi } ( z _ { t } , a _ { t } ) .\tag{1}
$$
...
$$
{ \mathcal { L } } _ { \mathrm { P L D M } } = { \mathcal { L } } _ { \mathrm { p r e d } } + \alpha { \mathcal { L } } _ { \mathrm { v a r } } + \beta { \mathcal { L } } _ { \mathrm { c o v } } + \gamma { \mathcal { L } } _ { \mathrm { t i m e - s i m } } + \zeta { \mathcal { L } } _ { \mathrm { t i m e - v a r } } + \nu { \mathcal { L } } _ { \mathrm { t i m e - c o v } } + \mu { \mathcal { L } } _ { \mathrm { I D M } }\tag{8}
$$
...
![](figs/lewm/figure_18.jpg)

Figure 18: Push-T Training curves for LeWM.

![](figs/lewm/figure_19.jpg)
